...
`,paraId:2,tocIndex:1}]},15983:function(P,s){s.Z=`import React, { forwardRef } from 'react';
...
export default forwardRef(ATable);
`},10384:function(P,s){s.Z=`import React, { useRef, useState } from 'react';
...
export default Demo;
`},87554:function(P,s){s.Z=`import React, { useRef, useState } from 'react';
